...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-3201055a8cc1f998"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Number theory, Prime numbers; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-3201055a8cc1f998",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-3201055a8cc1f998",
        "url": "https://en.wikipedia.org/wiki/Dickson%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Dickson's conjecture : for a finite set of linear forms $a_{1}+b_{1}n,\\ldots ,a_{k}+b_{k}n$ with each $b_{i}\\geq 1$ , there are infinitely many $n$ for which all forms are prime , unless there is some congruence condition preventing it.",
      "version": 1
    },
    "title": "Dickson's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "06a5b2c0653888556ee99dbd17e8541c19a1c5d6209da083deed35005593e186"
}
```
